<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:64:"D:\wamp\www\tp5\public/../application/admin\view\links\edit.html";i:1606120417;s:72:"D:\wamp\www\tp5\public/../application/admin\view\common\column_left.html";i:1605511265;s:67:"D:\wamp\www\tp5\public/../application/admin\view\common\header.html";i:1605689727;s:67:"D:\wamp\www\tp5\public/../application/admin\view\common\footer.html";i:1605086092;}*/ ?>
<!doctype html>
    ...
    <div class="top-right">
                        ...
                        <div class="page-header float-left">
                            <div class="page-title">
                                <ol class="breadcrumb text-left">
                                    ...
                                    <li><a href="<?php echo url('links/lists'); ?>">链接列表</a></li>
        ...
        <div class="content">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">修改链接</div>
                        <div class="card-body card-block">
                            <form action="#" method="post" class="middle-class">
                                <input type="hidden" name="id", value="<?php echo $linksInfo['id']; ?>">
                                <div class="form-group">
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class="fa fa-bars"></i>&nbsp;&nbsp;链接名称</div>
                                        <input type="text" id="title" name="title" value="<?php echo $linksInfo['title']; ?>" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class="fa fa-bookmark"></i>&nbsp;链接地址</div>
                                        <input type="text" id="url" name="url" value="<?php echo $linksInfo['url']; ?>" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class="fa fa-pencil-square"></i>&nbsp;链接描述</div>
                                        <textarea type="text" id="description" name="description" class="form-control"><?php echo $linksInfo['description']; ?></textarea>
                                    </div>
                                </div>
                                <div class="form-actions form-group">
                                    <button type="submit"class="btn btn-success btn-sm"><i class="fa fa-save"></i>&nbsp;修改信息</button>
                                </div>
                            </form>
                        </div>
                    </div>
