<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:68:"D:\wamp\www\tp5\public/../application/admin\view\category\lists.html";i:1606120140;s:72:"D:\wamp\www\tp5\public/../application/admin\view\common\column_left.html";i:1605511265;s:67:"D:\wamp\www\tp5\public/../application/admin\view\common\header.html";i:1605689727;s:67:"D:\wamp\www\tp5\public/../application/admin\view\common\footer.html";i:1605086092;}*/ ?>
<!doctype html>
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    <li><a class="btn btn-primary" href="<?php echo url('category/add'); ?>"><i class="fa fa-plus-square"></i> 添加栏目</a></li>
                                </ol>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="table-stats order-table ov-h dataTables_paginate paging_simple_numbers">
                                <table class="table ">
                                    ...
                                    <tbody>
                                        <?php if(is_array($list) || $list instanceof \think\Collection): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cateRes): $mod = ($i % 2 );++$i;?>
                                        <tr>
                                            <td class="serial"><?php echo $cateRes['id']; ?></td>
                                            <td> <span class="name"></span><?php echo $cateRes['category_name']; ?></td> </td>
                                            <td>
                                                <a class="btn btn-success" href="<?php echo url('category/edit',array('id'=>$cateRes['id'])); ?>"><i class="fa fa-edit"></i> 编辑</a>
                                                <butaton class="btn btn-danger" onclick="if(confirm('确定要删除吗?')) location.href='delete/id/<?php echo $cateRes['id']; ?>.html'"><i class="fa fa-trash-o"></i> 删除</butaton>
                                            </td>
                                        </tr>
