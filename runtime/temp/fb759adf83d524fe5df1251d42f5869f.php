<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:64:"D:\wamp\www\tp5\public/../application/admin\view\author\add.html";i:1606185173;s:72:"D:\wamp\www\tp5\public/../application/admin\view\common\column_left.html";i:1606183464;s:67:"D:\wamp\www\tp5\public/../application/admin\view\common\header.html";i:1605689727;s:67:"D:\wamp\www\tp5\public/../application/admin\view\common\footer.html";i:1605086092;}*/ ?>
<!doctype html>
    ...
    <div class="top-right">
        ...
        <div class="content">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">新增作者</div>
                        <div class="card-body card-block">
                            <form action="#" method="post" class="middle-class">
                                <div class="form-group">
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class="fa fa-user"></i>&nbsp;&nbsp;作者名称</div>
                                        <input type="text" id="author_name" name="author_name" placeholder="作者名称" class="form-control">
                                    </div>
                                </div>
