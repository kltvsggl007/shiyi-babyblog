<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:65:"D:\wamp\www\tp5\public/../application/admin\view\author\edit.html";i:1606186500;s:72:"D:\wamp\www\tp5\public/../application/admin\view\common\column_left.html";i:1606183464;s:67:"D:\wamp\www\tp5\public/../application/admin\view\common\header.html";i:1605689727;s:67:"D:\wamp\www\tp5\public/../application/admin\view\common\footer.html";i:1605086092;}*/ ?>
<!doctype html>
    ...
    <div class="top-right">
                        ...
                        <div class="page-header float-left">
                            <div class="page-title">
                                <ol class="breadcrumb text-left">
                                    ...
                                    <li><a href="<?php echo url('author/lists'); ?>">作者列表</a></li>
                                    <li class="active">修改作者</li>
                                </ol>
                            </div>
                        </div>
                    </div>
        ...
        <div class="content">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">修改作者</div>
                        <div class="card-body card-block">
                            <form action="#" method="post" class="middle-class">
                                <input type="hidden" name="id", value="<?php echo $AuthorInfo['id']; ?>">
                                <div class="form-group">
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class="fa fa-user"></i>&nbsp;&nbsp;作者名称</div>
                                        <input type="text" id="author_name" name="author_name" value="<?php echo $AuthorInfo['author_name']; ?>" class="form-control">
                                        <p class="red">*必填</p>
                                    </div>
                                </div>
