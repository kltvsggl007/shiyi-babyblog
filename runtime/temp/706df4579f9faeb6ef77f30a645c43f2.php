<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:66:"D:\wamp\www\tp5\public/../application/admin\view\category\add.html";i:1606120179;s:72:"D:\wamp\www\tp5\public/../application/admin\view\common\column_left.html";i:1605511265;s:67:"D:\wamp\www\tp5\public/../application/admin\view\common\header.html";i:1605689727;s:67:"D:\wamp\www\tp5\public/../application/admin\view\common\footer.html";i:1605086092;}*/ ?>
<!doctype html>
    ...
    <div class="top-right">
                        ...
                        <div class="page-header float-left">
                            <div class="page-title">
                                <ol class="breadcrumb text-left">
                                    ...
                                    <li><a href="<?php echo url('category/lists'); ?>">栏目列表</a></li>
        ...
        <div class="content">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">新增栏目</div>
                        <div class="card-body card-block">
                            <form action="#" method="post" class="middle-class">
                                <div class="form-group">
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class="fa fa-user"></i>&nbsp;&nbsp;栏目名称</div>
                                        <input type="text" id="category_name" name="category_name" placeholder="栏目名称" class="form-control">
                                    </div>
                                </div>
