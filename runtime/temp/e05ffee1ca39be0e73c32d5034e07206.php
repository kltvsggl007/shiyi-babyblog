<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:72:"D:\wamp\www\tp5\public/../application/admin\view\administrator\edit.html";i:1606120242;s:72:"D:\wamp\www\tp5\public/../application/admin\view\common\column_left.html";i:1605511265;s:67:"D:\wamp\www\tp5\public/../application/admin\view\common\header.html";i:1605689727;s:67:"D:\wamp\www\tp5\public/../application/admin\view\common\footer.html";i:1605086092;}*/ ?>
<!doctype html>
                        ...
                        <div class="page-header float-left">
                            <div class="page-title">
                                <ol class="breadcrumb text-left">
                                    ...
                                    <li><a href="<?php echo url('administrator/lists'); ?>">管理员列表</a></li>
                            ...
                            <form action="#" method="post" class="middle-class">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class="fa fa-user"></i>&nbsp;&nbsp;管理员名称</div>
                                        <input type="text" id="username" name="username" value="<?php echo $adminInfo['username']; ?>" class="form-control">
                                        <p class="red">*必填</p>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class="fa fa-asterisk"></i>&nbsp;管理员密码</div>
                                        <input type="password" id="password" name="password" placeholder="Password" class="form-control">
                                        <p class="red">*留空密码，则保存上次密码</p>
                                    </div>
                                </div>
