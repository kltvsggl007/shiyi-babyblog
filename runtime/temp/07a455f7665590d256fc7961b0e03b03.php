<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:71:"D:\wamp\www\tp5\public/../application/index\view\category\category.html";i:1606116268;s:67:"D:\wamp\www\tp5\public/../application/index\view\common\header.html";i:1606201861;s:75:"D:\wamp\www\tp5\public/../application/index\view\common\column_right_1.html";i:1606204796;s:75:"D:\wamp\www\tp5\public/../application/index\view\common\column_right_2.html";i:1606201662;s:67:"D:\wamp\www\tp5\public/../application/index\view\common\footer.html";i:1606114562;}*/ ?>
<!doctype html>
<html lang="en">
  <head>
    <!-- Required meta tags -->
...
<nav id="breadcrumbs" class="breadcrumbs">
	<div class="container page-wrapper">
		<a href="<?php echo url('index/index'); ?>">首页</a> / <span class="breadcrumb_last" aria-current="page"><a href="<?php echo url('category/index',array('cateid'=>$selectedCategory['id'])); ?>"><?php echo $selectedCategory['category_name']; ?></a></span>
	</div>
</nav>
    ...
    <div class="container py-lg-4 py-md-3">
        ...
        <div class="row">
            <div class="col-lg-8 most-recent">
                <h3 class="section-title-left"><?php echo $selectedCategory['category_name']; ?></h3>
               
                <div class="row">
                    <?php if(is_array($articleRes) || $articleRes instanceof \think\Collection): $i = 0; $__LIST__ = $articleRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$articles): $mod = ($i % 2 );++$i;?>
