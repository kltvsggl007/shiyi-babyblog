<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:65:"D:\wamp\www\tp5\public/../application/admin\view\article\add.html";i:1606190177;s:72:"D:\wamp\www\tp5\public/../application/admin\view\common\column_left.html";i:1606183464;s:67:"D:\wamp\www\tp5\public/../application/admin\view\common\header.html";i:1605689727;s:67:"D:\wamp\www\tp5\public/../application/admin\view\common\footer.html";i:1605086092;}*/ ?>
<!doctype html>
                            ...
                            <form action="#" enctype="multipart/form-data" method="post" class="card-body">
                                <div class="row form-group">
                                    <div class="input-group">
                                        ...
                                        <div class="col col-md-10"><input type="text" id="title" name="title" class="form-control"></div>
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="input-group">
                                        ...
                                        <select name="author_id" id="author_id" class="form-control">
                                            ...
                                            <option value="<?php echo $auRes['id']; ?>"><?php echo $auRes['author_name']; ?></option>
                                ...
                                <div class="row form-group">
                                    <div class="input-group">
                                        ...
                                        <div class="col col-md-10"><input type="text" id="keywords" name="keywords"  class="form-control"></div>
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="input-group">
                                        <div class="col col-md-2"><div class="input-group-addon"><i class="ti ti-comment-alt"></i>&nbsp;文章描述</div></div>
                                        <div class="col col-md-10"><textarea name="description" class="form-control"></textarea></div>
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="input-group">
                                        <div class="col col-md-2"><div class="input-group-addon"><i class="ti ti-image"></i>&nbsp;缩略图</div></div>
                                        <div class="col col-md-10"><input type="file" id="pic" name="pic" class="form-control-file"></div>
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="input-group">
                                        ...
                                        <select name="category_id" id="category_id" class="form-control">
                                            ...
                                            <option value="<?php echo $cateRes['id']; ?>"><?php echo $cateRes['category_name']; ?></option>
                                            <?php endforeach; endif; else: echo "" ;endif; ?>
                                        </select>
                                        </div>
                                    </div>
                                ...
                                <div class="row form-group">
                                    <div class="input-group">
                                        ...
                                        <div class="col col-md-10">
                                            <input type="checkbox" id="s4" name="state" checked="" style="display: none;" />
                                ...
                                <div class="row form-actions form-group">
                                    ...
                                    <div class="col-12 col-md-10"><button type="submit"class="btn btn-success btn-sm"><i class="ti ti-settings"></i>&nbsp;添加文章</button></div>
                                </div>
                            </form>
                        </div>
                    </div>
